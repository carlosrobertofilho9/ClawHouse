...
export default function ConsoleDesk({ className, width = "w-28", screenColor = "sky" }: ConsoleDeskProps) {
  const s = screenMap[screenColor];
  return (
    <div className={cn(width, "h-12 bg-slate-700 rounded-lg border-2 border-slate-600", className)}>
