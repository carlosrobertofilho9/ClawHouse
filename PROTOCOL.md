...
```json
{
  ...
  "narrative": "Claw está pesquisando sobre ABC Cardiologia..."
}
```
...
|------|---------------|-------------------|
| `session_start` | Usuário enviou mensagem | "Carlos chamou Claw no Kimi Chat" |
| `thinking` | Modelo começou a processar | "Claw está pensando..." |
| `tool_call` | Tool foi invocada | "Claw está pesquisando na web" |
| `file_edit` | Arquivo foi editado | "Claw editou PROMPT_FIXES_AUTH.md" |
| `web_search` | Busca na web | "Claw buscou 'OpenClaw WhatsApp setup'" |
| `message_sent` | Resposta enviada | "Claw respondeu (3.2k tokens)" |
| `session_end` | Turno terminou | "Claw ficou idle" |
| `error` | Erro ocorreu | "Claw encontrou um erro: timeout" |
| `idle` | Sem atividade por 30s | "Claw está descansando..." |
| `heartbeat` | Cron executou | "Claw verificou calendário" |
...
```jsonl
{"timestamp":"2026-04-25T22:30:00Z","type":"session_start","actor":"axioma_main","context":{"channel":"kimi-claw","user_id":"960611098"},"narrative":"Carlos chamou Claw"}
{"timestamp":"2026-04-25T22:30:01Z","type":"thinking","actor":"axioma_main","context":{"channel":"kimi-claw"},"narrative":"Claw está pensando sobre ClawHouse..."}
{"timestamp":"2026-04-25T22:30:03Z","type":"tool_call","actor":"axioma_main","activity":{"kind":"web_search","tool":"kimi_search","params":{"query":"OpenClaw activity stream"},"duration_ms":1200},"context":{"channel":"kimi-claw","room":"biblioteca"},"narrative":"Claw pesquisou sobre activity streams"}
{"timestamp":"2026-04-25T22:30:05Z","type":"file_edit","actor":"axioma_main","activity":{"file":"clawhouse/PROTOCOL.md","lines_added":45},"context":{"channel":"kimi-claw","room":"escritorio"},"narrative":"Claw documentou o protocolo"}
{"timestamp":"2026-04-25T22:30:10Z","type":"message_sent","actor":"axioma_main","activity":{"tokens":320,"channels":["kimi-claw"]},"context":{"channel":"kimi-claw"},"narrative":"Claw enviou a resposta"}
```
